...
// // Alimenti hardcoded dall'app originale
// const ALIMENTI_DA_IMPORTARE = {
//   // COLAZIONE
//   'Avena (fiocchi)': {
//     categoria: 'colazione',
//     proteine: 13.2,
...
// const INTEGRATORI_DA_IMPORTARE = {
...
// const seedAlimenti = async () => {
//   try {
//     console.log('🌱 Avvio seed database alimenti...');

//     // Connetti al database
//     await connectDB();

//     // Cancella alimenti esistenti (opzionale - commenta se vuoi preservare)
//     console.log('🗑️  Cancellazione alimenti esistenti...');
//     await Alimento.deleteMany({ verificato: false });

//     // Converti oggetto in array
//     const alimentiArray = Object.entries(ALIMENTI_DA_IMPORTARE).map(
//       ([nome, dati]) => ({
//         nome,
//         ...dati,
//         isPublico: true,
//         verificato: true, // Alimenti base sono verificati
//         tags: generaTags(nome, dati.categoria),
//       })
//     );
//     const integratoriArray = Object.entries(INTEGRATORI_DA_IMPORTARE).map(
//       ([nome, dati]) => ({
//         nome,
//         ...dati,
//         isPublico: true,
...
//     // Inserisci alimenti
//     console.log(`📥 Inserimento ${alimentiArray.length} alimenti...`);
//     console.log(`📥 Inserimento ${integratoriArray.length} integratori...`);
//     // const risultato = await Alimento.insertMany(alimentiArray, {
//     //   ordered: false, // Continua anche se alcuni falliscono (es. duplicati)
//     // });
//     // Inserisce nel database
//     const risultato = await Alimento.insertMany([
//       ...alimentiArray,
//       ...integratoriArray,
//     ]);
//     console.log(`✅ ${risultato.length} alimenti inseriti con successo!`);

//     // Statistiche
//     const stats = await Alimento.aggregate([
//       { $group: { _id: '$categoria', count: { $sum: 1 } } },
//     ]);

//     console.log('\n📊 Statistiche per categoria:');
//     stats.forEach((stat) => {
//       console.log(`  - ${stat._id}: ${stat.count} alimenti`);
//     });
...
// // Helper per generare tags automatici
// function generaTags(nome, categoria) {
//   const tags = [categoria];

//   // Aggiungi tags basati sul nome
...
// ⭐ FIX: Carica .env dalla directory corretta (parent di scripts)
...
if (!process.env.MONGODB_URI) {
  ...
  console.error('📂 Percorso .env cercato:', join(__dirname, '..', '.env'));
  console.error('💡 Assicurati che il file .env esista in /server/.env');
  process.exit(1);
}
...
const seedAlimenti = async () => {
  try {
    ...
    console.log(`✅ ${risultato.length} elementi inseriti con successo!`);
    ...
    console.log('\n📊 Statistiche per categoria:');
    stats.forEach((stat) => {
      console.log(`  - ${stat._id}: ${stat.count} elementi`);
    });
